...
const experiences = [
  {
    title: "Full Stack Developer",
    company_name: "Techies India inc",
    icon: "/assets/company/gdsc-logo.svg",
    iconBg: "#E6DEDD",
    date: "March 2024 - Present",
    points: [
      "I am a full-stack developer with a strong proficiency in React, Node.js, JavaScript, Laravel, and PostgreSQL. My expertise lies in building scalable, efficient, and user-friendly web applications. I have a deep understanding of both front-end and back-end development, enabling me to create seamless, end-to-end solutions. Whether working on complex backend logic with Node.js and Laravel or crafting dynamic, responsive user interfaces with React, I am committed to delivering high-quality, maintainable code. My experience with PostgreSQL ensures robust data management and performance optimization across all my projects."
    ],
  },
  {
...
const socials = [
  {
    id: "github",
    icon: <GithubIcon />,
    link: "https://github.com/usertechies",
  },
  {
    id: "linkedin",
    icon: <LinkedInIcon />,
    link: "https://www.linkedin.com/in/gobinda-kashyp-rajput-860a52208/?originalSubdomain=in",
  },
  {
    id: "x",
    icon: <XIcon />,
    link: "https://twitter.com/gobinda50332294",
  },
  {
    id: "instagram",
    icon: <InstagramIcon />,
